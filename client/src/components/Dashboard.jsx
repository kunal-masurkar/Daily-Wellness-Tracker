...
export function Dashboard({ user, onLogout, showToast, onUnauthorized }) {
  ...
  const getScoreStatus = (score) => {
    ...
    if (score >= 80) return { label: 'Optimal', color: 'var(--accent-emerald)' };
    if (score >= 60) return { label: 'Good', color: 'var(--accent-teal)' };
    ...
    <div className="app-container">
      ...
      <div className="dashboard-grid">
        ...
        <div className="card score-hero-card">
          <h3 style={{ color: 'var(--text-secondary)', fontSize: '1rem', fontWeight: 600 }}>
          ...
          <div 
            ...
            style={{ 
              backgroundColor: `${todayScoreStatus.color}20`,
          ...
          {todayCheckin ? (
            <div style={{ marginTop: '1.2rem', display: 'flex', gap: '1rem', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
              <span><Moon size={14} style={{ color: 'var(--primary)' }} /> {todayCheckin.sleep_hours}h</span>
              <span><Smile size={14} style={{ color: 'var(--accent-teal)' }} /> Mood {todayCheckin.mood}/10</span>
        ...
        <div className="card">
          ...
          <form onSubmit={handleSaveCheckin}>
            ...
            <div className="slider-group">
              <div className="slider-label-header">
                <span className="slider-label">
                  <Smile size={18} style={{ color: 'var(--accent-teal)' }} />
                  Mood Rating
                </span>
            ...
            <div className="live-preview-box">
              <span style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Calculated Score Preview:</span>
              <span style={{ fontSize: '1.2rem', fontWeight: 800, color: 'var(--text-primary)' }}>{liveScore} / 100</span>
            </div>
